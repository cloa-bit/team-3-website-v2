...
Police brutality has long been an issue in the United States. The recent killing of George Floyd has again cast a spotlight on policing practices in America. We decided to study data on the use of force by police in Minneapolis. Breaking it down by race we have the following.
...
Something imporant to keep in mind is that **only 18.6% of the population of Minneapolis is black** ^["U.S. Census website". United States Census Bureau. October 5, 2010.]. So it's obvious that a African Americans are disproportionately targeted by the police. Let's break it down by nieghborhood
